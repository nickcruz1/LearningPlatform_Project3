<!-- This will be a Big Learning Platform (Portfolio project: 
List of features:
- A Quiz
- Video tutorials/walkthrough of code
- Changing one set of code to another language/different style of code (modeled after Vue)
- Lots of Modals/Popups
- Include Vue Router
) -->
<template>
